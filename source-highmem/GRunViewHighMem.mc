...
*/
  ...
  function computeValue(info, id, value, valueData)
  {
    ...
    */
    ...
    {
      var requiredPace = GRunView.computeValue(info, id, value - OPTION_REQUIRED_SPEED_5K + 55 /* OPTION_REQUIRED_PACE_5K */, valueData);
  ...
  function printAllMetrics(info)
  {
    ...
    debugMetric("OPTION_ETA_100K", 54, "", info);
    debugMetric("OPTION_REQUIRED_PACE_5K", 55, "", info);
    debugMetric("OPTION_REQUIRED_PACE_10K", 56, "", info);
    debugMetric("OPTION_REQUIRED_PACE_HALF_MARATHON", 57, "", info);
    debugMetric("OPTION_REQUIRED_PACE_MARATHON", 58, "", info);
    debugMetric("OPTION_REQUIRED_PACE_100K", 59, "", info);
