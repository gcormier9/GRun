...
*/
    OPTION_AMBIENT_PRESSURE = 30,
    OPTION_AVERAGE_CADENCE = 31,
    OPTION_AVERAGE_DISTANCE = 32,
    OPTION_AVERAGE_POWER = 33,
    OPTION_BEARING = 34,
    OPTION_BEARING_FROM_START = 35,
    OPTION_CURRENT_HEADING = 36,
    OPTION_CURRENT_LOCATION = 37,
    OPTION_CURRENT_POWER = 38,
    OPTION_DISTANCE_TO_DESTINATION = 39,
    OPTION_DISTANCE_TO_NEXT_POINT = 40,
    OPTION_ELAPSED_TIME = 41,
    OPTION_ELEVATION_AT_DESTINATION = 42,
    OPTION_ELEVATION_AT_NEXT_POINT = 43,
    OPTION_ENERGY_EXPENDITURE = 44,
    OPTION_FRONT_DERAILLEUR_INDEX = 45,
    OPTION_FRONT_DERAILLEUR_MAX = 46,
    OPTION_FRONT_DERAILLEUR_SIZE = 47,
    OPTION_MAX_CADENCE = 48,
    OPTION_MAX_HEART_RATE = 49,
    OPTION_MAX_POWER = 50,
    OPTION_MAX_SPEED = 51,
    OPTION_MEAN_SEA_LEVEL_PRESSURE = 52,
    OPTION_NAME_OF_DESTINATION = 53,
    OPTION_NAME_OF_NEXT_POINT = 54,
    OPTION_OFF_COURSE_DISTANCE = 55,
    OPTION_RAW_AMBIENT_PRESSURE = 56,
    OPTION_REAR_DERAILLEUR_INDEX = 57,
    OPTION_REAR_DERAILLEUR_MAX = 58,
    OPTION_REAR_DERAILLEUR_SIZE = 59,
    OPTION_START_LOCATION = 60,
    OPTION_START_TIME = 61,
    OPTION_SWIM_STROKE_TYPE = 62,
    OPTION_SWIM_SWOLF = 63,
    OPTION_TIMER_STATE = 64,
    OPTION_TRACK = 65
  }
  ...
  {
    if (value <= 29 /* OPTION_CORRECTED_DISTANCE */) { return GRunView.computeValue(info, id, value, valueData); }
  ...
  {
    if (type <= 29 /* OPTION_CORRECTED_DISTANCE */) { return GRunView.getHeaderName(type); }
    /*
    switch (type)
    {
